<%@ page import="com.common.utils.UserUtils" %>
<%@ page import="com.common.realm.StatelessRealm" %>
<%@ page import="com.common.filter.StatelessAuthcFilter" %>
...
<div style="padding-left: 9px;">
    <%--<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-back'" onclick="history.go(-1)">返回</a>--%>

    <%

        //.getSubject().getSession().setAttribute("_relation_id",request.getParameter("ID"));
        //UserUtils.getSubject().getSession().setAttribute("_userout_id",request.getParameter("USERID"));
    %>
</div>
<div id="ckfinder"></div>
<script type="text/javascript">
    ...
    (function()
    {
        ...
        config.width =  '100%';
        config.height = '95%';
        //config.role="dddddddddddddddddddd";
        config.connectorInfo = 'ID=<%=request.getParameter("ID")%>&USERID=<%=request.getParameter("USERID")%>';
        config.folderRename="";
