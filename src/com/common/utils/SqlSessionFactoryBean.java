...
public class SqlSessionFactoryBean {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        if (StringUtils.isNotBlank(this.typeAliasesPackage)) {
            ...
            String[] typeAliasPackageArray = this.typeAliasesPackage.split(CONFIG_LOCATION_DELIMITERS);
        ...
        if (StringUtils.isNotBlank(this.typeHandlersPackage)) {
            ...
            String[] typeHandlersPackageArray = this.typeHandlersPackage.split(CONFIG_LOCATION_DELIMITERS);
